  ...
  const characteristics = [
    {
      ...
      title: "Adaptable",
      description: "Quick to adjust to new technologies, frameworks, and changing project requirements in dynamic environments."
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Flexible",
      description: "Comfortable working across different tech stacks and adapting development approaches based on project needs."
    },
    {
    ...
    },
    {
      ...
      title: "Collaborative",
      description: "Strong team player with excellent communication skills and ability to work in cross-functional teams."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A passionate web developer who thrives in dynamic environments and 
              is committed to delivering reliable digital solutions.
            </p>
          </div>
            ...
            >
              <div className="mb-12">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    An active <strong>Information Systems</strong> student with a strong interest in <strong>web development</strong>. Experienced in handling various personal projects and academic assignments as part of self-learning and personal growth. Actively participates in online training to broaden knowledge and improve technical skills. Highly committed to continuous learning, development, and ready to contribute meaningfully in a professional environment.
                  </p>
                  <p>
                  In every project, I apply a structured, solution-oriented approach. I believe that the combination of technical knowledge, willingness to learn, and teamwork is essential for delivering high-quality and impactful results.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">Universitas Teknologi Indonesia</p>
                    <p className="text-gray-600">2021 - Present</p>
                    <div className="flex items-center space-x-2 mt-2">
                      <span className="text-sm text-gray-600">Current GPA:</span>
                      <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-sm font-semibold">3.75/4.00</span>
                    </div>
                  </div>
                  <div className="pt-3 border-t border-gray-200">
                    <h6 className="font-medium text-gray-700 mb-2">Relevant Coursework:</h6>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">Database Systems</span>
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">Web Programming</span>
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">Software Engineering</span>
                      <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">System Analysis</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="grid gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Meticulous attention to detail ensuring high-quality code and user experience in every project."
                  },
                  {
                    icon: <Users className="w-8 h-8" />,
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-blue-600 text-white rounded-xl">
                  <div className="text-2xl font-bold mb-1">3.75</div>
