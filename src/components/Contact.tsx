...
const Contact = () => {
    ...
    const contactInfo = [
        {
            ...
            title: "Email",
            content: "adejui2711@gmail.com",
            link: "mailto:adejui2711@gmail.com",
            description: "For project inquiries and collaboration",
        },
        {
            icon: <Phone className="w-6 h-6" />,
            title: "Phone",
            content: "085740096548",
            link: "https://wa.me/6285740096548",
    ...
    const socialLinks = [
        ...
        },
        {
            ...
            name: "LinkedIn",
            username: "Ade Jui Nurrochim",
            url: "https://www.linkedin.com/in/ade-jui-nurrochim-24524a331/",
            color: "hover:text-blue-600 hover:bg-blue-50",
            description: "Professional network and experience",
        },
    ];

    const subjectOptions = ["Job Opportunity", "Freelance Project", "Collaboration", "Technical Consultation", "Other"];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Ready to help build innovative and reliable digital solutions for your next project. Let’s
                        ...
                        >
                            <div className="mb-12">
                                ...
                                {/* <p className="text-gray-600 mb-8 leading-relaxed">
                                    As an adaptable web developer who thrives in dynamic environments, I'm always
                                    excited to take on new challenges and contribute to innovative projects. Whether
                                    you're looking for a team member or a freelance developer, let's connect!
                                </p> */}
