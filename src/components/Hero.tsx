...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className="min-h-screen flex items-center pt-20 bg-gradient-to-br from-blue-50 via-white to-gray-50 relative overflow-hidden"
        >
                    ...
                    <div className="flex justify-center lg:justify-start hero-image-animate">
                        <div className="relative">
                            <img
                                src="./images/juii.png"
                                alt="ade"
                                className="w-80 h-80 lg:w-svw lg:h-auto rounded-2xl shadow-2xl object-cover transform hover:scale-105 transition-transform duration-500"
                            />
                    ...
                    <div className="text-center lg:text-left hero-text-animate">
                        ...
                        <div className="overflow-hidden mb-8">
                            <p className="text-xl text-gray-600 leading-relaxed hero-subtitle-slide">
                                Information Systems Student | Web Developer | Data Enthusiast
                            </p>
                        </div>
                        ...
                        <div className="hero-buttons-animate">
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                ...
                                >
                                    <span className="relative z-10">View My Project</span>
                                ...
                                <a
                                    href="./cv/AdeJui-CV.pdf"
                                    download
                                    className="group px-8 py-3 border-2 border-gray-900 text-gray-900 font-semibold rounded-lg hover:bg-gray-900 hover:text-white transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden"
                                >
